const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-2 sm:mx-4 shadow hover:shadow-lg transition-all duration-200 w-64 sm:w-72 shrink-0 bg-white">
    ...
    return (
        ...
        `}</style>
            ...
            <div className="text-center mt-16 px-4">
                <h2 className="text-slate-700 text-4xl sm:text-[42px] font-semibold">Loved by Creators</h2>
